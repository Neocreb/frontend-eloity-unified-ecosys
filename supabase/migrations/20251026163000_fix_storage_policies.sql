-- Fix storage bucket RLS policies for all public buckets
-- The current policies were preventing uploads from authenticated users
...
-- Create proper policies for posts bucket
...
-- Create proper policies for stories bucket
...
-- Create proper policies for products bucket
...
-- Create proper policies for portfolio bucket
...
-- Create proper policies for private buckets (documents, chat-attachments, verification, admin-assets, temp)
-- These should only allow access to owners
