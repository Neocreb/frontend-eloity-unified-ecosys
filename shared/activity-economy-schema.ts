...
export const rewardRules = pgTable('reward_rules', {
  ...
  decayRate: numeric('decay_rate', { precision: 5, scale: 4 }).default('0.1'),
  minMultiplier: numeric('min_multiplier', { precision: 3, scale: 2 }).default('0.1'),
  requiresModeration: boolean('requires_moderation').default(false),
  qualityThreshold: numeric('quality_threshold', { precision: 3, scale: 2 }).default('0'),
...
export const userRewards = pgTable('user_rewards', {
  ...
  rewardMultiplier: numeric('reward_multiplier', { precision: 3, scale: 2 }).default('1.0'),
...
export const rewardTransactions = pgTable('reward_transactions', {
  ...
  multiplierApplied: numeric('multiplier_applied', { precision: 3, scale: 2 }).default('1.0'),
  decayFactor: numeric('decay_factor', { precision: 3, scale: 2 }).default('1.0'),
