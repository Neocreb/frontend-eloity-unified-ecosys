...
const CreateChallenge: React.FC = () => {
  ...
  const getTotalPrizePool = () => {
    return formData.firstPrize + formData.secondPrize + formData.thirdPrize + (formData.participationReward * 50);
  };
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="max-w-2xl mx-auto">
          {currentStep === 1 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Must be unique and contain only letters and numbers</p>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-bold mb-4">Challenge Timeline</h3>
              </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 text-sm">Set rewards to motivate participation</p>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm font-medium">1st Place Prize (SP) *</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-sm font-medium">2nd Place Prize (SP) *</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-sm font-medium">3rd Place Prize (SP) *</Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label className="text-sm font-medium">Participation Reward (SP)</Label>
                  <Input
                    type="number"
              ...
              <Card className="bg-yellow-50 border-yellow-200">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-gray-700">Estimated Total Prize Pool</div>
                    ...
                    <div className="text-right">
                      <div className="text-sm text-gray-700">Your Balance</div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">Sponsored Challenge</div>
                      <div className="text-sm text-gray-600">Higher visibility, featured placement</div>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">Featured Challenge</div>
                      <div className="text-sm text-gray-600">Premium placement on homepage</div>
                    </div>
                  </div>
                  <Switch
          ...
          {currentStep === 4 && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 text-sm">Set clear guidelines for participants</p>
              </div>

              <div>
                <Label className="text-sm font-medium">Rules and Guidelines *</Label>
                <Textarea
          ...
          {currentStep === 5 && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 text-sm">Review your challenge details before publishing</p>
              </div>
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="text-blue-600 ml-2">#{formData.hashtag}</span>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    <div>
                      ...
                      <span className="text-yellow-600 font-bold ml-2">{formData.firstPrize} SP</span>
                    </div>
                    <div>
                      <span className="text-gray-600">2nd Prize:</span>
                      <span className="text-yellow-600 font-bold ml-2">{formData.secondPrize} SP</span>
                    </div>
                    <div>
                      <span className="text-gray-600">3rd Prize:</span>
                      <span className="text-yellow-600 font-bold ml-2">{formData.thirdPrize} SP</span>
                    </div>
                  </div>
