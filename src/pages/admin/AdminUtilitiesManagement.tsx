  ...
  const mockTransactions: Transaction[] = [
    {
      id: 'tx1',
      userId: 'user123',
      providerName: 'Electricity Company',
      amount: 5000,
      status: 'success',
  ...
  const handleSyncOperators = async () => {
    try {
      ...
      toast({
        ...
        description: 'Successfully synced utility operators from RELOADLY',
      });
    } catch (error) {
      toast({
        title: 'Error',
    ...
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Manage utility bill payments and operator settings
        </p>
      </div>
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          Utility payments are processed through RELOADLY. Ensure operator settings are correctly configured.
        </AlertDescription>
      </Alert>
      ...
      <Tabs defaultValue="transactions" className="space-y-6">
        ...
        <TabsContent value="transactions" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Utility Bill Transactions</CardTitle>
              <CardDescription>Monitor and manage utility bill payments</CardDescription>
            </CardHeader>
            <CardContent>
