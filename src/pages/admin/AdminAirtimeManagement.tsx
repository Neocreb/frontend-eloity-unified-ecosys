...
const AdminAirtimeManagement: React.FC = () => {
  ...
  const fetchOperators = async () => {
    try {
      const response = await fetch('/api/admin/reloadly/operators?serviceType=airtime');
  ...
  const fetchTransactions = async () => {
    try {
      const response = await fetch(
        `/api/admin/reloadly/transactions?type=airtime&limit=20`,
      );
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage airtime operators and monitor transactions</p>
      </div>
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest airtime transactions in the system</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="operators" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Synchronize operators from RELOADLY API</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage airtime service providers</CardDescription>
            </CardHeader>
            <CardContent>
...
export default AdminAirtimeManagement;
