  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Airtime Management</h1>
          <p className="text-gray-600 mt-1">Manage airtime operators and view transactions</p>
        </div>
      </div>
        ...
        <TabsContent value="operators" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sync and manage airtime operators</CardDescription>
            </CardHeader>
