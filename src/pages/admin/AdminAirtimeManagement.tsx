  ...
  const handleSyncOperators = async () => {
    try {
      ...
      toast({
        ...
        description: 'Successfully synced airtime operators from RELOADLY',
      });
    } catch (error) {
      toast({
        title: 'Error',
    ...
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Manage mobile airtime top-ups and operator settings
        </p>
      </div>
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          Airtime top-ups are processed through RELOADLY. Ensure operator settings are correctly configured.
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="transactions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor and manage airtime top-up transactions</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="operators" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Synchronize airtime operators from RELOADLY API</CardDescription>
            </CardHeader>
