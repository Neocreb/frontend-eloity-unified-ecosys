...
const AdminDataManagement: React.FC = () => {
  ...
  const fetchOperators = async () => {
    try {
      const response = await fetch('/api/admin/reloadly/operators?serviceType=data');
  ...
  const fetchTransactions = async () => {
    try {
      const response = await fetch('/api/admin/reloadly/transactions?type=data&limit=20');
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage data bundle providers and monitor transactions</p>
      </div>
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest data bundle transactions in the system</CardDescription>
            </CardHeader>
            <CardContent>
