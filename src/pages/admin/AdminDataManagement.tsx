    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage data bundle operators and view transactions</p>
        </div>
      </div>
        ...
        <TabsContent value="operators" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sync and manage data bundle operators</CardDescription>
            </CardHeader>
